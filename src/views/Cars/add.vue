    ...
    <el-form ref="form" :model="form" label-width="120px">
      <el-form-item label="车辆品牌">
        <el-select v-model="form.name">
          <el-option value="1">福特</el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="车辆型号">
        <el-select v-model="form.name">
          <el-option value="1">HHHH</el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="停车场">
        <el-select v-model="form.name">
          <el-option value="1">南山停车场</el-option>
        </el-select>
      </el-form-item>
      ...
      <el-form-item label="能源类型">
        ...
        <div
          ...
          v-if="form.energy == 3 || form.energy == 1"
        >
        ...
        <div
          class="progress-bar-wrap"
          v-if="form.energy == 3 || form.energy == 2"
        >
